                ...
                <form action="" method="post" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="editormd" id="editormdPlan">
                            {{--editormd的输入区域--}}
                            <textarea class="editormd-markdown-textarea" name="markdown_content" style="display: none;">{{ old('markdown_content') ? old('markdown_content') : $plan->markdown_content }}</textarea>
